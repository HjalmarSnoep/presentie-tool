...
<body>
	...
	if($uur==0)
	{
		...
		$x=round(10+(180*$minutes_today/540));
...
echo '	<path id="now" d="m0-0v32" fill="none" stroke="#f00" stroke-opacity=".5"/>';
echo '</defs>';
...
echo '</svg>';
	echo " <small style='color: silver;font-size: 12px;'>(score: ";
	echo (3600-$seconden_in_uur);
	?>)</small></h1>
	<?php
	...
	<div class="letop">
			...
			<a class="tooltip" href="media/regels.html" target="_blank"><img alt="Regels voor present zetten.." src="media/icon-info.svg" width="32" height="32"> <span class="tooltiptext">Regels voor present zetten..</span></a>
			<a class="tooltip" href="highscores.php" target="_blank"><img alt="Highscores" src="media/ranking.svg" width="32" height="32"> <span class="tooltiptext">Highscores</span></a>
			<a class="tooltip" href="https://github.com/MediacollegeAmsterdam/presentietool/issues" target="_blank"><img alt="Bugs" src="media/github.svg" width="32" height="32"> <span class="tooltiptext">Meld een technisch issue</span></a>
			<a class="tooltip" href="media/Roosterlokalen IDP.pdf" target="_blank"><img alt="Welk lokaal" src="media/welke_klas.svg" width="32" height="32"> <span class="tooltiptext">Welk lokaal moet ik zitten?</span></a>
			<a class="tooltip" style="float: right; padding-right: 30px;" href="https://drive.google.com/file/d/0B2RNo2h29YlQYkdMZ3dTb09WTmM/view" target="_blank"><img alt="Smoelenboek" src="media/smoelenboek.svg" width="32" height="32"> <span class="tooltiptext" style="right: 20px;">Smoelenboek</span></a>
	</div>
	<script>
